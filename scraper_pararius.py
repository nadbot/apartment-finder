...
def get_all_apartment_data_pararius(urls):
    ...
    if not os.path.isfile(csv_file := 'data/apartment_data_pararius.csv'):
...
def scrape_pararius(rerun_all=False):
    apartments_to_scrape = update_apartments(rerun_all)
    print(f'Updating {len(apartments_to_scrape)} entries')
    df = get_all_apartment_data_pararius(apartments_to_scrape)
    return df

if __name__ == '__main__':
    scrape_pararius(False)
